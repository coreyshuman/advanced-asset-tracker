...
public:
	...
	/**
	 * 16-bit X acceleration reading
	 */
	uint8_t x;

	/**
	 * 16-bit Y acceleration reading
	 */
	uint8_t y;

	/**
	 * 16-bit Z acceleration reading
	 */
	uint8_t z;
	...
	/**
	 * Returns magnitude of combined X, Y, and Z accelerations
	 */
	int16_t readXYZmagnitude();
